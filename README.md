...
<p align="center">
  <img src="aaaa.png" alt="Пример поста" width="400">
</p>
...
Когда пост исчезает, его комментарии отрываются от контекста и начинают самостоятельное плавание по ленте как загадочные послания без берегов.{в разработке}
